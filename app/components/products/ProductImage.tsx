...
import { CartProductType, SelectedImgType } from "@/app/product/[productId]/ProductDetils";
...
const ProductImage:React.FC<ProductImageProps> = ({cartProduct,product,handleColorSelect}) => {
    return ( <div className="grid grid-cols-6 gap-2 h-full max-h-[500px] min-h[300px] sm:min-h-[400px]">
        <div className="flex flex-col item-center justify-center gap-4 cursor-pointer gap-4 cursor-pointer border h-full max-h-[500px] min-h-[300px] sm:min-h-[400px]">
        ...
        <div className="col-span-5 relative aspect-square">
            <Image fill src={cartProduct.selectedImg.image} className="w-full h-full object-contain max-h-[500px] min-h-[300px] sm:min-h-[400px]" />
