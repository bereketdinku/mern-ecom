...
const SelectColor:React.FC<SelectColorProps> = ({item,addImageToState,removeImageFromState,isProductCreated}) => {
   ...
   return ( <div className="grid grid-cols-1 md:grid-cols-1 overflow-y-auto border-[1.2px] border-slate-200 items-center p-2">
    <div className="flex flex-row gap-2 items-center h-[60px]">
        <input  type="checkbox" checked={isSelected} onChange={handleCheck} className="cursor-pointer"/>
