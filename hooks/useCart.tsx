...
getTotals()
  ...
  localStorage.setItem('eShopCartItems',JSON.stringify(updatedCart))
    ...
    const value=
        {cartTotalQty,cartTotalAmount,cartProducts,handleAddProductToCart,handleRemoveProductFromCart,handleCartQtyIncrease,handleCartQtyDecrease,handleclearCart}
